import { TemperatureUnit, WeatherForecastEntry } from '@/store/types/weather';
...
export default function ForecastIntervalCard({ unit, timezone, interval }: ForecastIntervalCardProps) {
  return (
    <Card
      ...
      contentClassName="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3"
    >
